...
public class BluetoothDeviceSearch extends Activity 
{
    // Debugging
    private static final String TAG = "BluetoothDeviceSearch";
    ...
    {
        if(Constants.BTDEBUG) Log.d(TAG, "doDiscovery()");
    ...
    private OnItemClickListener mDeviceClickListener = new OnItemClickListener() 
    {
        public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3)
        {
            ...
            if(Constants.BTDEBUG) Log.d(TAG, "onItemClick() address: " + address);
