 ...
 */
public class WiFiConnectionManager implements Runnable
{
	...
	public void write(byte[] buffer, byte dataType)
	{
        ...
        if(Constants.WIFIDEBUG) Log.d(TAG, " Send data length: "+buffer.length);
        ...
        //if(Constants.WIFIDEBUG) 
        	Log.d(TAG, "Send data length: "+sendData.length);
